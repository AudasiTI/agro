(function () {
    ...
    var fazendasFactory = function ($http, $q) {
        var serviceBase = 'http://localhost:8080/agro/',
            factory = {};

        factory.getFazendas = function (pageIndex, pageSize) {
            return getPagedResource('fazenda', pageIndex, pageSize);
        };
    ...
    angular.module('agroWebApp').factory('fazendaService', fazendasFactory);
